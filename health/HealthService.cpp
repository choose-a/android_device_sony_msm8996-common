 ...
 */
#define LOG_TAG "android.hardware.health@2.0-service.sony_8996"
...
using ::device::sony::sony_8996::health::CycleCountBackupRestore;
using ::device::sony::sony_8996::health::LearnedCapacityBackupRestore;
